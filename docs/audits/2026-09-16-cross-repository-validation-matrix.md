...
| Clean Cortex artifact | `uv build --sdist --no-sources` plus archive inspection | 7.4 MiB sdist; generated viewer dependencies and test artifacts excluded | packaging test-confirmed |
